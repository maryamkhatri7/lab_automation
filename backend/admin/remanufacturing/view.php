<?php
// admin/remanufacturing/view.php
session_start();
...
<head>
    ...
    <title>View Re-Manufacturing - Admin</title>
...
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="top-bar">
                <div class="meta">
                    <div class="breadcrumb"><a href="../index.php">Admin</a> &rsaquo; <a href="list.php">Re-Manufacturing</a> &rsaquo; View</div>
                    <h1 style="margin:0;">Re-Manufacturing #<?php echo htmlspecialchars($rec['remanufacturing_id']); ?></h1>
                    <div class="top-actions">
                        ...
                        <a href="edit.php?id=<?php echo $rec['remanufacturing_id']; ?>" class="btn btn-edit"><svg class="icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.3 3.3l.7.7L5 12v1h1l8-8-.7-.7-1-1-.7-.7-1 1z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>Edit</a>
                        <a href="list.php?delete=<?php echo $rec['remanufacturing_id']; ?>" class="btn btn-delete confirm-delete" data-msg="Are you sure you want to delete this record?"><svg class="icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 5h10M6 5v8a1 1 0 001 1h2a1 1 0 001-1V5M5 5L6 2h4l1 3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>Delete</a>
                    </div>
                </div>
            </div>
            ...
            <div class="content-section">
                <div class="detail-row">
                    ...
                    <div class="val"><?php echo htmlspecialchars($rec['product_id'].' - '.$rec['product_name']); ?></div>
                </div>

                <div class="detail-row">
                    <span class="label">Date</span>
                    <div class="val"><?php echo date('M d, Y H:i', strtotime($rec['remanufacturing_date'])); ?></div>
                </div>

                <div class="detail-row">
                    <span class="label">Status</span>
                    <div class="val"><?php echo htmlspecialchars($rec['status']); ?><?php echo (!empty($rec['completed_date']) ? ' on '.htmlspecialchars($rec['completed_date']) : ''); ?></div>
                </div>

                <div class="detail-row">
                    <span class="label">Cost</span>
                    <div class="val"><?php echo $rec['cost'] ? '₹'.number_format($rec['cost'],2) : 'N/A'; ?></div>
                </div>

                <div class="detail-row">
                    <span class="label">Reason / Notes</span>
                    <div class="val"><?php echo nl2br(htmlspecialchars($rec['reason'] ?? '')); ?></div>
                </div>

                <div class="detail-row">
                    <span class="label">Created By</span>
                    <div class="val"><?php echo htmlspecialchars($rec['created_by_name']); ?></div>
                </div>
